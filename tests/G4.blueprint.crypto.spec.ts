...
describe("G4: blueprint registers crypto modules", () => {
  it("accepts ccm-hash, alpha-attestation, budget-receipt, boundary-proof, holo-signature", () => {
    ...
    const mods = {
      "atlas-12288/crypto/ccm-hash": JSON.parse(fs.readFileSync(path.resolve("atlas-12288/crypto/ccm-hash.json"), "utf8")),
      "atlas-12288/crypto/alpha-attestation": JSON.parse(fs.readFileSync(path.resolve("atlas-12288/crypto/alpha-attestation.json"), "utf8")),
      "atlas-12288/crypto/budget-receipt": JSON.parse(fs.readFileSync(path.resolve("atlas-12288/crypto/budget-receipt.json"), "utf8")),
      "atlas-12288/crypto/boundary-proof": JSON.parse(fs.readFileSync(path.resolve("atlas-12288/crypto/boundary-proof.json"), "utf8")),
      "atlas-12288/crypto/holo-signature": JSON.parse(fs.readFileSync(path.resolve("atlas-12288/crypto/holo-signature.json"), "utf8")),
    };
