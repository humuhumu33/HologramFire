...
describe("G10: blueprint registers deployment modules", () => {
  it("accepts semver policy, import verifier, fingerprint binding", () => {
    const mods = {
      "atlas-12288/deploy/semver-policy": read("atlas-12288/deploy/semver-policy.json"),
      "atlas-12288/deploy/import-verifier": read("atlas-12288/deploy/import-verifier.json"),
      "atlas-12288/deploy/fingerprint-binding": read("atlas-12288/deploy/fingerprint-binding.json")
    };
