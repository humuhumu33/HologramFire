...
describe("G3: blueprint registers RL-96 logic & proof modules", () => {
  it("accepts rl96 + proof modules with new invariants", () => {
    ...
    const mods = {
      "atlas-12288/logic/rl96": JSON.parse(fs.readFileSync(path.resolve("atlas-12288/logic/rl96.json"), "utf8")),
      "atlas-12288/logic/proof": JSON.parse(fs.readFileSync(path.resolve("atlas-12288/logic/proof.json"), "utf8")),
    };
