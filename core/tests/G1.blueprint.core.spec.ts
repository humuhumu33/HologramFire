...
describe("G1: blueprint registers P-Core modules", () => {
  it("accepts structure/resonance/conservation/holography modules", () => {
    ...
    const mods = {
      "atlas-12288/core/structure": JSON.parse(fs.readFileSync(path.resolve("data/atlas-12288/core/structure.json"), "utf8")),
      "atlas-12288/core/resonance": JSON.parse(fs.readFileSync(path.resolve("data/atlas-12288/core/resonance.json"), "utf8")),
      "atlas-12288/core/conservation": JSON.parse(fs.readFileSync(path.resolve("data/atlas-12288/core/conservation.json"), "utf8")),
      "atlas-12288/core/holography": JSON.parse(fs.readFileSync(path.resolve("data/atlas-12288/core/holography.json"), "utf8")),
    };
