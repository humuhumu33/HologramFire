...
describe("G8: blueprint registers persistence modules", () => {
  it("accepts snapshot, ledger, gc modules", () => {
    const mods = {
      "data/atlas-12288/persistence/snapshot": read("data/atlas-12288/persistence/snapshot.json"),
      "data/atlas-12288/persistence/ledger":   read("data/atlas-12288/persistence/ledger.json"),
      "data/atlas-12288/persistence/gc":       read("data/atlas-12288/persistence/gc.json")
    };
