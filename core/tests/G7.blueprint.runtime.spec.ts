...
describe("G7: blueprint registers runtime modules", () => {
  it("accepts VPI and LocalVerifier modules", () => {
    ...
    const mods = {
      "atlas-12288/runtime/vpi": JSON.parse(fs.readFileSync(path.resolve("data/atlas-12288/runtime/vpi.json"), "utf8")),
      "atlas-12288/runtime/local-verifier": JSON.parse(fs.readFileSync(path.resolve("data/atlas-12288/runtime/local-verifier.json"), "utf8")),
    };
