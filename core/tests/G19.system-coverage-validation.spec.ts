  ...
  describe('Cross-Component Integration', () => {
    it('should validate blueprint registration components exist', () => {
      const blueprintComponents = [
        'data/atlas-12288/blueprint/blueprint.json',
        'data/atlas-12288/blueprint/blueprint.schema.json',
    ...
    it('should validate performance benchmarks and targets exist', () => {
      const performanceComponents = [
        ...
        'src/perf/benches',
        'data/atlas-12288/perf/targets.json',
        'data/atlas-12288/perf/benches.json'
      ];
